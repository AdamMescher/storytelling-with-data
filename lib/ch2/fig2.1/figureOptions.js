export const horizontalBarOptions = {
    ...
    yAxis: {
      gridLineWidth: 0,
      plotLines: [{ color: 'red', width: 54, value: 0, zIndex: 10 }]
    },
...
export const lineChartOptions = {
  ...
  xAxis: {
    minPadding: 0.1,
    maxPadding: 0.1,
    plotLines: [{ color: 'red', width: 2, value: 0 }]
  },
  yAxis: {
    minPadding: 0.2,
    maxPaddign: 1,
    gridLineWidth: 0,
    plotLines: [{ color: 'red', width: 2, value: 0.1 }]
  },
  plotOptions: {
    series: {
...
export const slopegraphOptions = {
    ...
    yAxis: {
      ...
      title: { text: null },
      gridLineWidth: 0,
      plotLines: [{ color: 'red', width: 4, value: 1 }]
    },
    plotOptions: {
        line:{
            lineWidth:4,
...
export const stackedHorizontalBarOptions = {
  ...
  yAxis: {
    gridLineWidth: 0,
    plotLines: [{ color: 'red', width: 4, value: 0, zIndex: 10 }]
  },
  plotOptions: {
        series: {
          cursor: 'pointer',
...
export const stackedVerticalBarOptions = {
  ...
  yAxis: {
    gridLineWidth: 0,
    plotLines: [{ color: 'red', width: 4, value: 0.2 } ]
  },
  legend: { enabled: false },
  plotOptions: {
...
export const verticalBarOptions = {
    ...
    xAxis: {
      ...
      labels: { enabled: false },
      lineWidth: 0,
      plotLines: [{ color: 'red', width: 3, value: -0.53, zIndex: 10 }]
    },
    yAxis: {
      gridLineWidth: 0,
      lineWidth: 0,
      plotLines: [{ color: 'red', width: 3, value: 0.05, zIndex: 10 }]
    },
    series: [{ data: [4, 5, 4, 3, 8] }],
    plotOptions: { series: { cursor: 'pointer' } },
    credits: { enabled: false },
...
export const waterfallOptions = {
  ...
  xAxis: {
    ...
    tickWidth: 0,
    lineWidth: 0,
    plotLines: [{ color: 'red', width: 4, value: -0.53 }]
  },
  yAxis: {
    title: { text: null },
    gridLineWidth: 0,
